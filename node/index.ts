...
const clients: ClientsConfig<Clients> = {
  // We pass our custom implementation of the clients bag, containing the Reviews client.
  ...
  options: {
    ...
    // This key will be merged with the default options and add this cache to our Reviews client.
    status: {
      memoryCache,
    },
  },
